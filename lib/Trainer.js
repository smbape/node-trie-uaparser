...
Object.assign(exports, {
    train: opts => {
        ...
        software.indexes = ((obj, prop1, prop2) => {
            const trackProp = (obj, property, cb) => {
                const handler = {
                    set(obj, prop, value) {
                        if (prop === property) {
                            if (cb) {
            ...
            if (prop1 && prop2) {
                obj[prop1] = trackProp(obj[prop1], prop2);
            }

            return trackProp(obj, prop1, prop2 == null ? null : obj => {
                return trackProp(obj, prop2);
            });
        })(software.indexes, "tokens", "boardreader blog indexer");
